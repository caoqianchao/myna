...
public class DateUtils {
    ...
    /**
     * 获取指定 （yyyyMMdd)格式日期 的 当天开始 时间string yyyMMddHHmmssSSS
     *
     * @param date
     * @return
     */
    ...
    public static Date getBeginDateTime(Date date) {
        ...
        return DateUtils.toDateTime(dateStr + "000000000", "yyyyMMddHHmmssSSS");
    }

    /**
     * 获取指定 （yyyyMMdd)格式日期 的 当天结束 时间string yyyMMddHHmmssSSS
     *
     * @param date
     * @return
     */
