...
public class ParameterUtils {
     ...
     * 简易客服电话格式
     */
    public static Pattern patternServicePhone = Pattern.compile("^[0-9-]{5,19}$");

    /**
     * 5到30位数字组成字符串
     */
    public static Pattern patternAccount = Pattern.compile("^[1-9]{1}+\\d{4,25}$");

    /**
     * 16到19位数字，非零开头
     */
    public static Pattern patternBankCard = Pattern.compile("^[1-9]{1}+\\d{15,18}$");

    /**
     * 员工编号：1-20位数字、字母组成
     */
    public static Pattern patternEmpNo = Pattern.compile("[a-zA-Z0-9]{1,20}");
    ...
    public static void main(String[] args) {
        System.out.println(patternAccount.matcher("999999999999999999999999999999").matches());
     ...
     * 客服电话验证
     */
    public static boolean checkServicePhone(String servicePhone) {
        return patternServicePhone.matcher(servicePhone).matches();
    }

    /**
     * 员工编号验证
     */
    public static boolean checkEmpNo(String empNo) {
        return patternEmpNo.matcher(empNo).matches();
    }
...
//        return true;
        return patternBankCard.matcher(bankCard).matches();
    }
